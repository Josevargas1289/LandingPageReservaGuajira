...
class ArboretumTabHome extends Component {
  render() {
    /* service tab menu */
    ...
    return (
      <div id="changePosition">
        {/*====================  service tab area ====================*/}
        <div className="service-tab-area section-space--inner--120 animate__animated animate__backInUp">
              ...
              <div className="col-lg-12">
                ...
                <div className="container">
                  ...
                  <p className="single-feature-icon__content">
                    ...
                    vida silvestre y los ecosistemas. Este arboretum
                    proporcionará diversos beneficios ecológicos. Los árboles
                    plantados servirán como fuente de semillas para la
                    regeneración natural o asistida de los bosques, protegiendo
                    el suelo y manteniendo su fertilidad. Además, ayudarán a
                    moderar el clima, creando microclimas estables y propicios
                    para el crecimiento de las plantas, así como a regular el
                    ciclo del agua al aumentar la humedad y facilitar la
                    penetración del agua en el suelo. También contribuirán a
                    favorecer la supervivencia y biodiversidad de otros
...
export default ArboretumTabHome;
